...
typedef struct cat_socket_crypto_options_s {
    /*
     * peer_name: peer_name is used to verify the peer name of the peer certificate,
     * and it's also used to set the server name for SNI.
     */
    ...
    const char *ca_file;
    /*
     * ca_path: ca_path is used to load the CA certificate from a path (i.e directory).
     */
    const char *ca_path;
    /*
     * load_ca: a function to load the CA certificate,
     * you may use it to load the CA certificate from a custom source like memory.
     */
    cat_load_certificate_t load_ca;
    /*
     * certificate: certificate is used to load the local certificate from a file.
     */
    const char *certificate;
    /*
     * certificate_key: certificate_key is used to load the local certificate key from a file.
     */
    const char *certificate_key;
    /*
     * passphrase: passphrase is used to decrypt the local certificate key.
     */
    const char *passphrase;
    /*
     * load_certificate: a function to load the local certificate,
     * you may use it to load the local certificate from a custom source like memory.
     */
    cat_load_certificate_t load_certificate;
#ifdef CAT_SSL_HAVE_SECURITY_LEVEL
    /*
     * security_level: security_level is used to set the security level of the SSL connection.
     * see SSL_CTX_set_security_level(3)
     */
    int security_level;
#endif
#ifdef CAT_SSL_HAVE_TLS_ALPN
    /*
     * alpn_protocols: alpn_protocols is used to set the ALPN protocols of the SSL connection.
     */
    const char *alpn_protocols;
#endif
    /*
     * protocols: protocols is used to set the protocols of the SSL connection.
     */
    cat_ssl_protocols_t protocols;
    /*
     * verify_depth: verify_depth is used to set the trusted CA certificate chain depth of the SSL connection.
     */
    int verify_depth;
    /*
