...
typedef enum cat_log_union_types_e {
    CAT_LOG_TYPES_ALL             = (int) (CAT_LOG_TYPE_DEBUG | CAT_LOG_TYPE_INFO | CAT_LOG_TYPE_NOTICE | CAT_LOG_TYPE_WARNING | CAT_LOG_TYPE_ERROR | CAT_LOG_TYPE_CORE_ERROR),
    CAT_LOG_TYPES_DEFAULT         = (int) (CAT_LOG_TYPES_ALL ^ (int) CAT_LOG_TYPE_DEBUG),
    CAT_LOG_TYPES_ABNORMAL        = (int) (CAT_LOG_TYPE_NOTICE | CAT_LOG_TYPE_WARNING | CAT_LOG_TYPE_ERROR | CAT_LOG_TYPE_CORE_ERROR),
    CAT_LOG_TYPES_UNFILTERABLE    = (int) (CAT_LOG_TYPE_ERROR | CAT_LOG_TYPE_CORE_ERROR),
