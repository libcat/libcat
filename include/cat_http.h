...
enum cat_multipart_state
{
    ...
    CAT_HTTP_MULTIPART_BOUNDARY_COMMON_START,
    CAT_HTTP_MULTIPART_BOUNDARY_QUOTED_START,
    CAT_HTTP_MULTIPART_BOUNDARY_COMMON_END,
    CAT_HTTP_MULTIPART_BOUNDARY_QUOTED_END,
...
#undef CAT_HTTP_PARSER_EVENT_GEN
    ...
    _CAT_HTTP_PARSER_EVENT_MULTIPART_BODY_END = (1 << 15) |
        CAT_HTTP_PARSER_EVENT_FLAG_COMPLETE |
        CAT_HTTP_PARSER_EVENT_FLAG_MULTIPART ,
